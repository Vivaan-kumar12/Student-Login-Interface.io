...
if (
    ...
    page.includes("tuition-profile.html") ||
...
const profile = {
    ...
    try{
        ...
        alert("Tuition Profile Saved Successfully");
...
async function loadSchoolProfile(){
    ...
    if(
        !location.pathname.includes("tuition-profile.html")
    ) return;
...
// ==========================
// Show Tuition Name (live from Firestore, if a school-profile/tuition-profile page sets it)
// ==========================
...
// ==========================
// Class Level Icons (visual only)
// ==========================

const wingIcons = {
  "Primary Level": "fa-graduation-cap",
  "Middle Level": "fa-calculator",
  "Secondary Level": "fa-flask",
  "Senior Level": "fa-star"
};
...
async function openClassModal(classId) {
  ...
  if (editingClassId) {
    ...
    if (snap.exists()) {
      ...
      document.getElementById("classWing").value = c.wing || "Primary Level";
...
// ----- Payment Settings (UPI ID for the Parent Portals
...
async function savePaymentSettings() {
  ...
  try {
    await setDoc(doc(db, "settings", "payment"), {
      upiId,
      payeeName: payeeName || "Home Tuition Classes"
    }, { merge: true });
